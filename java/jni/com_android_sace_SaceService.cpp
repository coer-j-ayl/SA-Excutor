...
JNIEXPORT jint JNICALL Java_com_android_sace_SaceService_nGetError (JNIEnv *env __unused, jobject obj __unused, jlong ptr) {
    sp<SaceServiceObj> sve = reinterpret_cast<SaceServiceWrapper*>(ptr)->sve;
    return static_cast<jint>(sve->getError());
}
