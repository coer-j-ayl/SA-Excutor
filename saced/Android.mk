...
LIB_SACE_INCLUDE = $(LOCAL_PATH)/../libsace $(LOCAL_PATH)/../libsace/include
LOCAL_SRC_FILES :=               \
...
LOCAL_SHARED_LIBRARIES := liblog libcutils libutils libbinder libselinux libcap libsace libprocessgroup
LOCAL_MODULE := saced
