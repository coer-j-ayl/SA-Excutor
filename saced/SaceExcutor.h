...
#define CLOSE_WAIT_TOTAL_TIME    2000 //ms
#define CLOSE_WAIT_KILL_TIME     1000 //ms
...
struct CommandInfo;
    ...
    map<SaceClientIdentifier, vector<uint64_t>> mClientCmd;
...
private:
    ...
    void destroyNormalCmd (sp<SaceReaderMessage>);
